...
public class User {
    ...
    public Integer getEarnedLeaveBalance() { return earnedLeaveBalance; }
    public void setEarnedLeaveBalance(Integer earnedLeaveBalance) { this.earnedLeaveBalance = earnedLeaveBalance; }
    
    public Integer getCompensatoryLeaveBalance() { return compensatoryLeaveBalance; }
    public void setCompensatoryLeaveBalance(Integer compensatoryLeaveBalance) { this.compensatoryLeaveBalance = compensatoryLeaveBalance; }
    ...
    public boolean canManageHRPolicies() {
        return isHrOrAdmin();
    }
}
